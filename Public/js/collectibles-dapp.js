function TncDapp() {
    ...
    this.getWalletNfts = async function (address) {
        ...
        if (chain_id == '4689') {
            ...
            let nfts = await tncLib.getNftsByAddress(address, nftverse);
    ...
    this.render = async function (erc1155, id, address) {
        ...
        if (chain_id == '4689' && erc1155.toLowerCase() == tncLibBridgeIn.Address.toLowerCase()) {
        ...
        let tmpl = _this.collectibleTemplate({
            ...
            srcId: srcInfo[1],
            bridgeOn: chain_id == '4689' ? chain_id : '',
            bridgeOnBack: bridgeBack ? chain_id : '',
            checkOpenSea: chain_id == '4689' || chain_id == '4' ? 'Check on OpenSea' : 'Open Details',
            image: data_image,
    ...
    this.startAccountCheck = function () {
        ...
        if (window.web3) {
            ...
            window.web3.on('accountsChanged', function (accounts) {
                const _that = _this;
    ...
    this.startChainCheck = function () {
        ...
        if (window.web3) {
            window.web3.on('chainChanged', async function (chain) {
