function TncDapp() {
        ...
        for (let i = offset; i < nfts.length; i++) {
            ...
            try {
                ...
                if (typeof data == 'object') {
                    ...
                    if (chain_id == '4689' || disable_royalties_button) {
    ...
    this.newUpdateCollection = async function (e) {
        ...
        let iotx = await web3.utils.fromWei(await window.tncLib.getPoolMinimumIotx());

        $('#iotxMinCollection').html(iotx);
            ...
            if ($('#nftIsEdit').val() == '0') {
                ...
                await window.tncLib.newNft(
                    ...
                    function (receipt) {
                        ...
                        if (chain_id != '4689') {
                            _alert('<div style="font-size: 1.6rem;">Your NFT has been successfully created!<br/><br/>You may want to sell your NFT from within your <a href="collectibles.html">wallet</a> in our <a href="market.html">marketplace</a> (only 2% sale fees, custom royalties and more).<br/><br/>You can also create your own marketplace using our <a href="market-builder.html">Market Builder</a> and set yourself apart from the competition!<br/><br/>Free white-label solution available on <a href="https://github.com/TheVanquiser/Dapps-market-place-NFTs-to-IoTeX" target="_blank">Github</a>.</div>');
                        } else {
                            _alert('<div style="font-size: 1.6rem;">Your NFT has been successfully created!<br/><br/>You can create your own marketplace using the <a href="market-builder.html">Market Builder</a> and set yourself apart from the competition!<br/><br/>Free white-label solution available on <a href="https://github.com/TheVanquiser/Dapps-market-place-NFTs-to-IoTeX" target="_blank">Github</a>.</div>');
                        }
                    },
                    function (err) {
                        toastr.remove();
