 ...
 */
contract IoTeX is ERC1155Tradable {

    string private _contractURI = "https://iotexnfts.web.app/meta/contract.json";

	constructor(address _proxyRegistryAddress) public ERC1155Tradable("IoTeX", "IOTX", _proxyRegistryAddress) {
		_setBaseMetadataURI("https://iotexnfts.web.app/meta/");
	}
