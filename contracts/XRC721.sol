 ...
 * {ERC721Enumerable}.
 */
contract XRC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = XRC721.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(XRC721.ownerOf(tokenId) == from, "ERC721: transfer of token that is not own");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(XRC721.ownerOf(tokenId), to, tokenId);
    }
