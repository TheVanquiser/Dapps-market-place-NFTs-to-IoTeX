function TncLibBridge(){
    ...
    if(chain_id == '4689'){
        this.chainIn = new web3.eth.Contract(bridgeInABI, '0x009EA04f3dda1b0C847c9C7307638d4287c9C2B6', {from: this.account});
    }

    // IOTEX
    if(chain_id === "4689") {

        this.ethOut = new web3.eth.Contract(bridgeOutABI, '0x009EA04f3dda1b0C847c9C7307638d4287c9C2B6', {from: this.account});

        this.marketplaceNFTsverseAddress = '0x009EA04f3dda1b0C847c9C7307638d4287c9C2B6';
    ...
    this.getBridgedId = async function(chainId, srcErc1155Address, srcId){
        ...
        await sleep(sleep_time);
        return await this.nftverse.methods.getBridgedId(chainId, srcErc1155Address, srcId).call({from:this.account});
    ...
    this.in_getSourceInfo = async function(nftId){
        ...
        await sleep(sleep_time);
        return await this.nftverse.methods.getBridgedSrc(nftId).call({from:this.account});
