...
let api_url = 'EBE8538B-CD15-4CDA-A50A-1CE550831A7B';
...
$(document).ready(function () {
    ...
    if (chain_id == '61' || chain_id == '38') {
        ...
        $('#linkToIotx').css('display', 'block');
        $('#shopIotx').css('display', 'inline-block');
        $('#shopIotx').css('display', 'none');
    }
...
function displayNulsScoInfo() {
    ...
    _alert("Project capital funding is brokered by <a href=\"https://www.nuls.io/\" target=\"_blank\">NULS'</a> <a href=\"https://nuls.medium.com/nuls-2-0-project-nerve-network-bridges-into-the-larger-bitcoin-and-ethereum-universe-5a54bf0138e6\" target=\"_blank\">SCO</a> platform (Staked Coin Output) and highly recommended by the NFTs project.<br /><br />\n" +
        ...
        "\n" +
        "Disclaimer: Our support for NULS' project funding is not a paid promotion. We are planning to build native NULS chain support for NFTs. Once completed, tokens created on NULS' SCO platform will be directly usable with our platform and won't need any bridging.\n" +
        "\n" +
        "\n" +
        "\n");
