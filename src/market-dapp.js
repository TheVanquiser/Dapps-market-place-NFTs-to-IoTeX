    ...
    this.populateTokenLookup = async function (e) {
        ...
        switch (chain_id) {
            case '4689': // IoTeX
                ...
                var o = new Option("IOTX (IoTeX)", "0x6fb3e0a217407efff7ca062d46c26e5d60a14d69");
                $(o).html("IOTX (IoTeX)");
                ...
                var o3 = new Option("USDT", " 0xdac17f958d2ee523a2206206994597c13d831ec7 ");
                $(o3).html("USDT");
